    ...
    frontendIPConfigurations: [
      {
        ...
        properties: {
          ...
          subnet: {
            id: '/subscriptions/${subscription().subscriptionId}/resourceGroups/${resourceGroup().name}/providers/Microsoft.Network/virtualNetworks/primary-region-vnet/subnets/app-subnet'
          }
        }
      }
    ]
